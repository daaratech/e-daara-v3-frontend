    ...
    <v-container fluid>
        <div class="d-flex justify-space-between">
            <h5 class="text-h5 font-weight-bold">
                Liste des classes <v-icon>mdi-account-group</v-icon>
            </h5>
            <div>
                Trier par :
                <v-menu offset-y>
        ...
        <v-data-iterator :items="classes" :page="page" :itemsPerPage="$vuetify.display.mdAndUp ? 8 : 4">
                ...
                <v-row>
                    ...
                    >
                        <v-card color="#eeeeee">
                            ...
                            <v-card-text>
                                <p>
                                    {{ format(item.raw.createdAt) }}
                                </p>
                                <p>{{ item.raw.students.length }} élèves</p>
                                <p>{{ item.raw.professors.length }} enseignants</p>
                            </v-card-text>
                            <v-card-actions>
                                <v-btn text color="primary" :to="{name: 'ClasseShow', params: {id: item.raw.id}}">
                                  Voir &nbsp;
                                  <v-icon>
                                    mdi-eye
                                  </v-icon>
